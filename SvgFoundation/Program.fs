module SvgWorkspacePublicClean.SvgFoundation
...
open SvgWorkspacePublicClean.TacticalCompatibility
#endif
#if SVG_INPUT_CANDIDATE
open FS.GG.UI.KeyboardInput
module GameInput = SvgWorkspacePublicClean.SvgFoundation.PlayerInput
#endif
#if SVG_RUNTIME_CANDIDATE
open FS.GG.Game.Core
module ContinuousPlayer = SvgWorkspacePublicClean.SvgFoundation.ContinuousPlayer
#if !LEGACY_SVG_PREVIEW
module SvgAuthority = SvgWorkspacePublicClean.SvgAuthority
#endif
#endif
...
module ScalePlayer = SvgWorkspacePublicClean.SvgFoundation.ScalePlayer
#endif
#if ARCADE_EXAMPLE
module ArcadeExample = SvgWorkspacePublicClean.SvgFoundation.ArcadeExample
#endif
#if TACTICAL_EXAMPLE
module TacticalExample = SvgWorkspacePublicClean.SvgFoundation.TacticalExample
#endif
...
let private persistenceHost =
    new BrowserPersistenceHost(
        { DatabaseName = "SvgWorkspacePublicClean-svg-player"
...
#if !LEGACY_SVG_PREVIEW
let private applyAuthority status (players: SvgAuthority.Player list) tick round health score collected outcome contentId contentSchema (content: SvgWorkspacePublicClean.ArenaContent.ArenaContent) hazardCol hazardRow =
