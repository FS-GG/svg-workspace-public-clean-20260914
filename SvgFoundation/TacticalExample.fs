module SvgWorkspacePublicClean.SvgFoundation.TacticalExample
...
module RuleModel = SvgWorkspacePublicClean.SvgFoundation.TacticalRuleModel
module Control = SvgWorkspacePublicClean.TacticalRules
