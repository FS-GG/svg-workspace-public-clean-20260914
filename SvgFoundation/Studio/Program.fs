module SvgWorkspacePublicClean.SvgFoundation.Studio.Program
...
module ArenaRules = SvgWorkspacePublicClean.ArenaRules
#if SVG_INPUT_CANDIDATE
open FS.GG.UI.KeyboardInput
module WorkspaceCommands = SvgWorkspacePublicClean.SvgFoundation.Studio.WorkspaceInput
#endif
...
let private persistence =
    new BrowserPersistenceHost(
        { DatabaseName = "SvgWorkspacePublicClean-svg-studio"
