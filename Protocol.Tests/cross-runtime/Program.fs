module SvgWorkspacePublicClean.Protocol.Tests.CrossRuntime.Program
...
open SvgWorkspacePublicClean.ArenaRules
open SvgWorkspacePublicClean.SvgFoundation.Studio.SceneSchema
open FS.GG.UI.Scene
module Arcade = SvgWorkspacePublicClean.ArcadeRules
module Tactical = SvgWorkspacePublicClean.TacticalRules
